    ...
    >
      <div className="flex justify-between items-start mb-4">
        <div className="flex-1">
          <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">{event.titulo}</h3>
      ...
      <p className="text-gray-600 dark:text-gray-400 mb-4 line-clamp-2">{event.descripcion}</p>
