...
export default function Events() {
  ...
  return (
    <div className="px-4 py-6">
      ...
      >
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Mis Eventos</h1>
      ...
      {!events || events.length === 0 ? (
        ...
        >
          ...
          <h3 className="text-xl font-semibold text-gray-700 dark:text-gray-300 mb-2">No tienes eventos</h3>
          <p className="text-gray-500 dark:text-gray-400 mb-6">Comienza creando tu primer evento</p>
