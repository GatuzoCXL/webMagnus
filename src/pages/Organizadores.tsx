    ...
    <div className="px-4 py-6 max-w-7xl mx-auto">
      ...
      >
        <div className="flex justify-between items-center mb-4">
          <div>
            <h1 className="text-3xl font-bold text-gray-900 mb-2">Organizadores de Bodas</h1>
            <p className="text-gray-600">Encuentra el planificador perfecto para tu evento</p>
          </div>
        </div>
      </motion.div>
      ...
      {organizadores.length === 0 ? (
        ...
        >
          ...
          <h2 className="text-xl font-semibold text-gray-700 mb-2">No hay organizadores disponibles</h2>
          <p className="text-gray-500">Regístrate como organizador para aparecer aquí</p>
        </motion.div>
      ) : (
                ...
                <div className="flex items-start justify-between mb-3">
                  <div className="flex-1">
                    ...
                    {organizador.especialidad && (
                      <p className="text-sm text-gray-600">{organizador.especialidad}</p>
                    )}
                  </div>
