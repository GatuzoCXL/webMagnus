    ...
    return (
      <div className="px-4 py-6">
        <div className="card text-center py-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Organizador no encontrado</h2>
    ...
    <div className="px-4 py-6 max-w-4xl mx-auto">
      ...
      >
        <div className="flex items-start justify-between mb-6">
          <div>
            <h1 className="text-3xl font-bold text-gray-900 mb-2">{organizador.nombreEmpresa}</h1>
            {organizador.especialidad && (
              <p className="text-lg text-gray-600">{organizador.especialidad}</p>
            )}
          </div>
        ...
        <div className="flex items-center mb-6">
          <div className="flex items-center mr-6">
            ...
            <span className="ml-2 text-2xl font-bold text-gray-900">{organizador.rating.toFixed(1)}</span>
          </div>
        ...
        {organizador.descripcion && (
          <div className="mb-6">
            <h2 className="text-xl font-semibold text-gray-900 mb-3">Sobre nosotros</h2>
            <p className="text-gray-600 whitespace-pre-wrap">{organizador.descripcion}</p>
          </div>
        )}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          <div className="bg-gray-50 p-6 rounded-lg">
            ...
            <div className="space-y-3">
              <div className="flex items-center">
                ...
                <span className="text-gray-900">{organizador.telefono}</span>
              </div>
              {organizador.direccion && (
                <div className="flex items-start">
                  ...
                  <span className="text-gray-900">{organizador.direccion}</span>
                </div>
              )}
            </div>
          </div>
          ...
          <div className="bg-primary-light p-6 rounded-lg">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Precio por Evento</h3>
            <div className="flex items-baseline">
              <span className="text-4xl font-bold text-primary">${organizador.precioPorEvento.toLocaleString()}</span>
            </div>
            <p className="text-sm text-gray-600 mt-2">Precio base por evento</p>
